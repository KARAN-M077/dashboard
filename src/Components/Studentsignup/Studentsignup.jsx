...
function Studentsignup() {
  return (
    <>
      <div className='bg-[#F5F3ED] pt-10 pb-5 px-16 h-[140vh] overflow-y-scroll flex flex-col gap-16 mt-[1%] mx-auto align-middle items-center w-full max550:px-5' style={{ fontFamily: 'Work Sans, sans-serif' }}>
        <div className='text-black gap-8 flex flex-col justify-center w-[70%] max550:w-full'>
          <h1 className='text-5xl font-semibold text-center text-[#383838]'>Fill your details</h1>
          ...
          <div className='flex justify-center mx-auto w-[90%] max550:w-full max550:px-5'>
            <Link to='/Landing' className='text-center text-white bg-[#FC661A] rounded-[5px] py-[10px] w-full active:bg-[#D94F12] transition duration-150 ease-in-out text-[18px]'>
              SignUp
            </Link>
          </div>
